...
> 截止：2026-8-9 ｜ 当前代码版本 v0.5.14（D21 默认模型切 qwen3.7-flash + 禁用 qwen3.6-flash；Railway 需手动 Redeploy 拉取）
...
3. **同步更新使用手册版本号（已完成）**
   - `使用手册.md` 已同步到 **v0.5.14** / D21，版本一致，评委不会看到版本错配。
...
| 作品使用手册 | ✅ | `使用手册.md`，已同步 v0.5.14（含 30 秒体验指南） |
